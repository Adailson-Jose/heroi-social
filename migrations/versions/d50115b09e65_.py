...
Revision ID: d50115b09e65
Revises: 
Create Date: 2018-07-07 23:35:57.558135
...
def upgrade():
    ...
    op.create_table('acidente',
                    ...
                    sa.Column('data_abertura', sa.String(length=45), nullable=True),
                    sa.Column('hora_abertura', sa.String(length=45), nullable=True),
                    sa.Column('qtd_vitimasfatais', sa.String(length=45), nullable=True),
                    sa.Column('tipo_ocorrencia', sa.String(length=45), nullable=True),
                    sa.Column('quantidade_vitimas', sa.String(length=45), nullable=True),
    ...
    op.create_table('equipamento_fiscalizacao',
                    ...
                    sa.Column('contrato', sa.String(length=5), nullable=True),
